...
RSpec.describe ProjectAssigneeContact, type: :model do
  it "requires default_email and unique normalized name per project" do
    ...
    blank_email = build(:project_assignee_contact, project: project, assignee_name_normalized: "bob", default_email: "")
